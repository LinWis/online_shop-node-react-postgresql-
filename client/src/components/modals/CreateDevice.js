      ...
      >
        ...
        <Modal.Body>
            <Form>
                ...
                <Button variant='outline-dark' onClick={addInfo}>Добавить новые свойства</Button>
                    ...
                    <Row className='mt-3' key={item.number}>
                      <Col md={4}>
                        <Form.Control placeholder='Введите название характеристики'
                         value={item.title} onChange={e => changeInfo('title', e.target.value, item.number)}/>
                      </Col>
                      <Col md={4}>
                        <Form.Control placeholder='Введите описание'
                         value={item.description} onChange={e => changeInfo('description', e.target.value, item.number)}/>
                      </Col>
                      <Col md={4}>
                        <Button onClick={() => removeInfo(item.number)} variant='outline-danger'>Удалить</Button>
                      </Col>
                    </Row>
                  ))
                }
